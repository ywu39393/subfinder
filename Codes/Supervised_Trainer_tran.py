...
#     avg_class_acc_k = 0
    ...
    for train_index, test_index in skf_outer.split(data["sig_gene_seq"],
        ...
        if featurizer == "countvectorizer":
        ...
        elif featurizer in ["lstm_with_attention_d2v_dbow", 'lstm_with_attention_d2v_dm', 'lstm_with_attention_w2v_cbow', 'lstm_with_attention_w2v_sg', 'lstm_with_attention_ft_sg', 'lstm_with_attention_ft_cbow',
            ...
            if featurizer in ['vanilla_lstm_d2v_dbow', 'vanilla_lstm_d2v_dm', 'vanilla_lstm_w2v_cbow', 'vanilla_lstm_w2v_sg', 'vanilla_lstm_ft_sg', 'vanilla_lstm_ft_cbow']:
                 model_dl = simple_lstm(len(order), False, model)
            
            elif featurizer in ["lstm_with_attention_d2v_dbow", 'lstm_with_attention_d2v_dm', 'lstm_with_attention_w2v_cbow', 'lstm_with_attention_w2v_sg', 'lstm_with_attention_ft_sg', 'lstm_with_attention_ft_cbow']: 
                model_dl = attention_lstm_model(len(order), False, model)
    
            elif featurizer in ["just_attention_d2v_dbow", 'just_attention_d2v_dm', 'just_attention_w2v_cbow', 'just_attention_w2v_sg', 'just_attention_ft_sg', 'just_attention_ft_cbow']:
                model_dl = non_recurrent_attention_model(len(order), False, model)
            
            elif featurizer in ["transformer_d2v_dbow", 'transformer_d2v_dm', 'transformer_w2v_cbow', 'transformer_w2v_sg', 'transformer_ft_sg', 'transformer_ft_cbow']:
